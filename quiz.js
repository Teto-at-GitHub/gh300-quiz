...
function shuffleQuestion(q) {
  const indexed = q.opts.map((opt, i) => ({
    opt,
...
function submit() {
  ...
  q.opts.forEach((_, i) => {
    ...
    b.disabled = true;
    if (q.correct.includes(i) && selected.includes(i))
      b.className = "opt correct";
    else if (q.correct.includes(i) && !selected.includes(i))
      b.className = "opt missed";
    else if (!q.correct.includes(i) && selected.includes(i))
      b.className = "opt incorrect";
  });
